  ...
  return (
    <>
      {initialData ?
                ...
                <header className='bg-white z-10 text-sm sm:text-base py-5 mx-3 md:mx-6'>
                  <div className='flex flex-wrap justify-between items-center'>
                    <span className='text-xl'>
                      <Link to='/' className='bg-gradient-to-b from-secondary to-primary bg-clip-text text-transparent'>Boards </Link>
                      <span className=''>/</span>
                      <input type="text" defaultValue={boardName} className='text-tertiary ml-2 w-1/2 truncate' onChange={(e) => changeBoardName(e.target.value)} />
                    </span>
        ...
        :
        <div className="splash-screen h-screen w-screen" />
      }
    </>
  )
}
