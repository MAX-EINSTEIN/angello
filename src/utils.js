...
export const createBoardForAnons = (userId) => {
	const tasks = [
		{
			id: '1',
			title: 'Welcome to Angello 🙌',
			description: 'Angello Kanban Board help you to be more productive by providing integration with google services',
			priority: 'low',
			dateAdded: new Date(),
			todos: []
		},
...

		{
			...
			priority: "medium",
			todos: [],
			description: "### Tell me your suggestions, feedback or anything at all!\n[This](http://github.com/MAX-EINSTEIN/angello) is the link to the Github repo. Drop a 🌟 if you like it. \n**Keep a beginner motivated**."
		},
